...
if __name__ == "__main__":
    ...
    noise_cov = 1e04 * 0.5 * radiometer_eq(autos@x_true, ants, delta_time, delta_freq)
    ...
    a_0 = np.zeros_like(x_true) #np.random.randn(x_true.size)*np.sqrt(prior_cov) + x_true # gaussian centered on alms with S variance 
