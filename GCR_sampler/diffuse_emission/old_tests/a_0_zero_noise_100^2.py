...
if __name__ == "__main__":
    ...
    noise_cov = 100**2 * radiometer_eq(autos@x_true, ants, delta_time, delta_freq)
    ...
    # setting the prior mean to zero
    a_0 = np.zeros_like(np.random.randn(x_true.size)*np.sqrt(prior_cov) + x_true) # gaussian centered on alms with S variance 
